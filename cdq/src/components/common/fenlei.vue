<template>
  <div>
    ...
    <div class="top">
      <!-- 分类按键 -->
      <div class="caidan" @click="toShou">
        <img src="../img/fenlei/xiaoyu.png" style="width:25px;height:25px;" alt />
        <br />
      </div>
      <!-- 搜索框 -->
      <div style="width:100% ;padding-right:20px;padding-left:6px;" @click="chuan">
        <img id="fdj" src="../img/fenlei/fdj.png" alt />
        <input id="shousuo" type="text" placeholder="请输入商品名称" />
      </div>
      <div class="xioaxi">
        <img src="../img/fenlei/gd.png" alt />
        <br />
      </div>
    </div>
    <!-- 分类主体 -->
...
export default {
  data() {
    return {
      ...
      pingpai: [
        {
          src: require("../img/fenlei/pingpai/QuanZL/logo1.webp"),
          name: "比瑞吉"
        },
        {
          src: require("../img/fenlei/pingpai/QuanZL/logo1.webp"),
