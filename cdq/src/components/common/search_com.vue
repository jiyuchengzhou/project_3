<template>
    <div>
        ...
        <div class="top">
            <!-- 分类按键 -->
            <div class="caidan">
                <img src="../img/fenlei/xiaoyu.png" style="width:25px;height:25px;"  alt=""><br>
            </div>
            <!-- 搜索框 -->
        ...
        <div class="list" style="display:flex;background:rgb(247, 248, 249);flex-wrap:wrap;">
            <div v-for="(item,i) in products" :key=i :class="{'odd_s':(i+1)%2!=0}" style="width:47%;box-sizing:border-box;background:white;margin-top:10px;">
                <div class="pro" style="width:100%;">
                    <router-link :to="{path:'/details',query:{ id:item.id }}" style="text-decoration:none;color:black;">
                        <img style="width:100%;" :src="require('../'+item.src)" alt="">
                        <div style="margin-top:5px;padding:5px;padding-top:1px;overflow:hidden;height:33px;">{{item.intr}}</div>
                    </router-link>
